...
- `TicketInventoryService`
  ...
  - Veiller a changer `server.port` ou utiliser un proxy/API Gateway pour eviter les conflits de port.
...
- Definir un API Gateway ou un systeme de discovery (ex. Spring Cloud Gateway, Traefik) pour agrerger les endpoints.
